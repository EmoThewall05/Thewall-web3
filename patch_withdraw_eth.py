#!/usr/bin/env python3
"""
TheWall Web3 - Add approval confirmation step to ETH withdraw flow
Run this from ~/Thewall-web3
"""

path = 'app/withdraw-eth/page.tsx'
...
print("[OK] wrote app/withdraw-eth/page.tsx with approval confirmation step")
print("\\nPuthiya flow:")
print("1. Preview & Confirm -> simulate")
print("2. Confirm Send -> approval record create (approve/route.ts action=create)")
print("3. 'Final Approval Required' modal -> Approve/Deny")
print("4. Approve -> approve/route.ts action=approved -> prepare+sign+broadcast")
print("5. Deny -> approve/route.ts action=rejected -> cancel, no signing happens")
